...
impl<'de> Deserialize<'de> for JsonFile {
        ...
        D: de::Deserializer<'de>,
    {
        ...
        impl<'d> Visitor<'d> for JsonFileVisitor {
            ...
            #[tracing::instrument(level = "info", skip(self, access))]
...
impl Compiler {
    #[tracing::instrument(level = "info", skip(arch))]
    ...
    #[tracing::instrument(level = "info", skip(self, filters, is_basic))]
...
mod tests {
    ...
    impl Filter {
        #[tracing::instrument(level = "info", skip(default_action, filter_action, filter))]
        pub fn new(
            default_action: SeccompAction,
            filter_action: SeccompAction,
            filter: Vec<SyscallRule>,
    ...
    impl SyscallRule {
        #[tracing::instrument(level = "info", skip(syscall, conditions))]
    ...
    #[tracing::instrument(level = "info", skip(syscall_number, action))]
