...
impl<'de> Deserialize<'de> for JsonFile {
    #[tracing::instrument(level = "trace", ret(skip), skip(deserializer))]
        ...
        D: de::Deserializer<'de>,
    {
        ...
        impl<'d> Visitor<'d> for JsonFileVisitor {
            ...
            #[tracing::instrument(level = "trace", ret(skip), skip(self,access))]
...
impl Compiler {
    #[tracing::instrument(level = "trace", ret(skip), skip(arch))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,filters))]
    /// Perform semantic checks after deserialization.
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,filters,is_basic))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,filter))]
...
mod tests {
    ...
    impl Filter {
        #[tracing::instrument(level = "trace", ret(skip), skip(default_action,filter_action,filter))]
        pub fn new(
            default_action: SeccompAction,
            filter_action: SeccompAction,
            filter: Vec<SyscallRule>,
    ...
    impl SyscallRule {
        #[tracing::instrument(level = "trace", ret(skip), skip(syscall,conditions))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(syscall_number,action))]
