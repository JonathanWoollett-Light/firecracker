...
impl<'de> Deserialize<'de> for Comment {
    #[tracing::instrument(level = "trace", ret(skip), skip(_deserializer))]
...
impl From<TargetArch> for &str {
    #[tracing::instrument(level = "trace", ret(skip), skip(target_arch))]
...
impl SeccompCondition {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,offset))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,offset,mask))]
...
impl From<SeccompAction> for u32 {
    #[tracing::instrument(level = "trace", ret(skip), skip(action))]
...
impl SeccompRule {
    #[tracing::instrument(level = "trace", ret(skip), skip(conditions,action))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(condition,accumulator,rule_len,offset))]
...
impl From<SeccompRule> for BpfProgram {
    #[tracing::instrument(level = "trace", ret(skip), skip(rule))]
...
impl SeccompFilter {
    #[tracing::instrument(level = "trace", ret(skip), skip(rules,default_action,target_arch))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(syscall_number,chain,default_action,accumulator,filter_len))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(code,k,jt,jf))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(code,k))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(syscall_number,rules))]
    ...
    impl SeccompCondition {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(arg_number,arg_len,operator,value))]
        pub fn new(
            arg_number: u8,
            arg_len: SeccompCmpArgLen,
            operator: SeccompCmpOp,
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(bpf_filter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(rules,validation_fn,should_fail))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(arg_len))]
