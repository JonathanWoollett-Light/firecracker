...
impl DataTypeToken {
    ...
    /// Returns if the type is non-zero.
...
impl DataType {
    ...
    pub const fn size(self) -> u8 {
        match self {
            Self::U8 | Self::NonZeroU8 => 8,
            Self::U16 | Self::NonZeroU16 => 16,
            Self::U32 | Self::NonZeroU32 => 32,
            Self::U64 | Self::NonZeroU64 => 64,
            Self::U128 | Self::NonZeroU128 => 128,
        }
    }
    /// Returns if the type is non-zero.
    pub const fn is_nonzero(self) -> bool {
        match self {
            ...
            | Self::NonZeroU32
            | Self::NonZeroU64
            | Self::NonZeroU128 => true,
        }
    }
    /// Returns base data type.
    pub fn base(self) -> TokenStream {
        match self {
            Self::U8 | Self::NonZeroU8 => quote! { u8 },
            Self::U16 | Self::NonZeroU16 => quote! { u16 },
            Self::U32 | Self::NonZeroU32 => quote! { u32 },
            Self::U64 | Self::NonZeroU64 => quote! { u64 },
            Self::U128 | Self::NonZeroU128 => quote! { u128 },
        }
    }
}
...
impl fmt::Display for DataType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Self::NonZeroU128 => write!(f, "NonZeroU128"),
            Self::NonZeroU64 => write!(f, "NonZeroU64"),
            Self::NonZeroU32 => write!(f, "NonZeroU32"),
            Self::NonZeroU16 => write!(f, "NonZeroU16"),
            Self::NonZeroU8 => write!(f, "NonZeroU8"),
        }
    }
}
...
impl FromStr for DataType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "u64" => Ok(Self::U64),
            "u128" => Ok(Self::U128),
            "NonZeroU8" => Ok(Self::NonZeroU8),
            "NonZeroU16" => Ok(Self::NonZeroU16),
            "NonZeroU32" => Ok(Self::NonZeroU32),
            "NonZeroU64" => Ok(Self::NonZeroU64),
            "NonZeroU128" => Ok(Self::NonZeroU128),
...
#[error(
    "Bad backing data type given. Only accepted types are `u8`, `u16`, `u32`, `u64`, `u128`, \
     `NonZeroU8`, `NonZeroU16`, `NonZeroU32`, `NonZerou64` and `NonZeroU128`."
)]
...
mod tests {
    ...
    fn data_type_try_from_error_display() {
        assert_eq!(
            ...
            "Bad backing data type given. Only accepted types are `u8`, `u16`, `u32`, `u64`, \
             `u128`, `NonZeroU8`, `NonZeroU16`, `NonZeroU32`, `NonZerou64` and `NonZeroU128`."
        );
    }
