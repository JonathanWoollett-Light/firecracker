...
#[tracing::instrument(level = "trace", skip(arg_parser))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(base_file,diff_file))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(file,expected_content))]
