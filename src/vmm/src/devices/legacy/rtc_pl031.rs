...
mod tests {
    ...
    fn test_rtc_invalid_buf_len() {
        ...
        rtc_pl031.bwrite(0x008, &write_data_good);
        rtc_pl031.bwrite(0x008, &data_bad);
        rtc_pl031.bread(0x008, &mut read_data_good);
        rtc_pl031.bread(0x008, &mut data_bad);
