...
impl MutEventSubscriber for BusDevice {
    #[tracing::instrument(level = "info", skip(self, event, ops))]
...
impl Bus {
    ...
    #[tracing::instrument(level = "info", skip(self, device, base, len))]
    ...
    #[tracing::instrument(level = "info", skip(self, addr, data))]
