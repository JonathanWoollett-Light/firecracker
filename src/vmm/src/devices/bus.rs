...
impl MutEventSubscriber for BusDevice {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,event,ops))]
...
impl Bus {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,device,base,len))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,addr,data))]
