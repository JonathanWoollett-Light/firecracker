...
#[tracing::instrument(level = "trace", ret(skip), skip(buf))]
...
impl Net {
    #[tracing::instrument(level = "trace", ret(skip), skip(id,tap,guest_mac,rx_rate_limiter,tx_rate_limiter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(id,tap_if_name,guest_mac,rx_rate_limiter,tx_rate_limiter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,ipv4_addr,mmds))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,queue_type))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(rate_limiter,size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(mem,data,head))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(mmds_ns,rate_limiter,headers,frame_iovec,tap,guest_mac))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,rx_bytes,rx_ops,tx_bytes,tx_ops))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(tap,buf))]
    #[cfg(not(test))]
...
impl VirtioDevice for Net {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,acked_features))]
...
pub mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(src_mac,src_ip,dst_mac,dst_ip))]
