...
impl Mocks {
    #[tracing::instrument(level = "info", skip(self, read_tap))]
    pub fn set_read_tap(&mut self, read_tap: ReadTapMock) {
        self.read_tap = read_tap;
    }

    #[tracing::instrument(level = "info", skip(self, write_tap))]
...
impl TapTrafficSimulator {
    #[tracing::instrument(level = "info", skip(tap_index))]
...
#[tracing::instrument(level = "info", skip(tap))]
...
#[tracing::instrument(level = "info", skip(net, len))]
#[cfg(test)]
...
#[tracing::instrument(level = "info", skip(net, idx, val))]
...
#[tracing::instrument(level = "info", skip(net, idx))]
...
#[tracing::instrument(level = "info", skip(net, mac))]
...
#[tracing::instrument(level = "info", skip(net, rxq, txq))]
...
pub mod test {
    ...
    impl<'a> TestHelper<'a> {
        ...
        #[tracing::instrument(level = "info", skip(self, frame_len))]
        ...
        #[tracing::instrument(level = "info", skip(self, expected_frame))]
        ...
        #[tracing::instrument(level = "info", skip(self, desc_list, frame_len))]
