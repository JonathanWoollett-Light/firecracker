...
impl Mocks {
    #[tracing::instrument(level = "trace", skip(self,read_tap))]
    pub fn set_read_tap(&mut self, read_tap: ReadTapMock) {
        self.read_tap = read_tap;
    }

    #[tracing::instrument(level = "trace", skip(self,write_tap))]
...
impl TapTrafficSimulator {
    #[tracing::instrument(level = "trace", skip(tap_index))]
...
#[tracing::instrument(level = "trace", skip(tap))]
...
#[tracing::instrument(level = "trace", skip(net,len))]
#[cfg(test)]
...
#[tracing::instrument(level = "trace", skip(net,idx,val))]
...
#[tracing::instrument(level = "trace", skip(net,idx))]
...
#[tracing::instrument(level = "trace", skip(net,mac))]
...
#[tracing::instrument(level = "trace", skip(net,rxq,txq))]
...
pub mod test {
    ...
    impl<'a> TestHelper<'a> {
        ...
        #[tracing::instrument(level = "trace", skip(self,frame_len))]
        ...
        #[tracing::instrument(level = "trace", skip(self,expected_frame))]
        ...
        #[tracing::instrument(level = "trace", skip(self,desc_list,frame_len))]
