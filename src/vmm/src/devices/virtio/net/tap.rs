...
// contains if_name.
#[tracing::instrument(level = "info", skip(if_name))]
...
impl IfReqBuilder {
    ...
    #[tracing::instrument(level = "info", skip(self, if_name))]
    ...
    #[tracing::instrument(level = "info", skip(self, socket, ioctl))]
...
impl Tap {
    ...
    #[tracing::instrument(level = "info", skip(self, size))]
    ...
    #[tracing::instrument(level = "info", skip(self, buffer))]
