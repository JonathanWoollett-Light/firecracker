...
impl<'a> IovVecSubregion<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(iovecs,len,offset,size))]
...
impl IoVecBuffer {
    #[tracing::instrument(level = "trace", ret(skip), skip(mem,head))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,offset,size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,offset))]
...
mod tests {
    ...
    impl<'a> From<Vec<&'a [u8]>> for IoVecBuffer {
        #[tracing::instrument(level = "trace", ret(skip), skip(buffer))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(m,is_write_only))]
