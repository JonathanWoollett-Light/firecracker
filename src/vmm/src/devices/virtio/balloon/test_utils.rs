...
#[tracing::instrument(level = "trace", ret(skip), skip(b,queue_index))]
#[cfg(test)]
...
#[tracing::instrument(level = "trace", ret(skip), skip(queue,idx,addr,len,flags))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(queue,idx))]
