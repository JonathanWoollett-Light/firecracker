...
#[tracing::instrument(level = "trace", ret(skip), skip(amount_mib))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(amount_pages))]
...
impl BalloonStats {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,stat))]
...
impl Balloon {
    #[tracing::instrument(level = "trace", ret(skip), skip(amount_mib,deflate_on_oom,stats_polling_interval_s,restored))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,interval_s))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,stats_desc_index))]
...
pub(crate) mod tests {
    ...
    impl Balloon {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,idx,q))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,num_pages))]
        pub fn update_num_pages(&mut self, num_pages: u32) {
            self.config_space.num_pages = num_pages;
        }

        #[tracing::instrument(level = "trace", ret(skip), skip(self,actual_pages))]
