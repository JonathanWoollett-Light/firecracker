...
impl IrqTrigger {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,irq_type))]
...
pub(crate) mod tests {
    ...
    impl VirtioDevice for MockVirtioDevice {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,_acked_features))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,_mem))]
