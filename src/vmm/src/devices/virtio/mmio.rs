...
pub(crate) mod tests {
    ...
    fn test_bus_device_write() {
        ...
        for i in (0..0xeff).rev() {
            ...
            d.bwrite(0x100 + i as u64, &buf1[i..]);
            d.bread(0x100, &mut buf2[..]);
