...
impl MmioTransport {
    ...
    #[tracing::instrument(level = "info", skip(self, set, clr))]
    ...
    #[tracing::instrument(level = "info", skip(self, d, f))]
...
impl MmioTransport {
    ...
    pub fn bus_write(&mut self, offset: u64, data: &[u8]) {
        #[tracing::instrument(level = "info", skip(v, x))]
...
pub(crate) mod tests {
    ...
    impl DummyDevice {
        ...
        #[tracing::instrument(level = "info", skip(self, avail_features))]
    ...
    #[tracing::instrument(level = "info", skip(d, status))]
    ...
    #[tracing::instrument(level = "info", skip(d))]
