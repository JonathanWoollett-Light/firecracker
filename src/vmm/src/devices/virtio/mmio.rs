...
impl MmioTransport {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,set,clr))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,d,f))]
...
impl MmioTransport {
    ...
    pub fn bus_write(&mut self, offset: u64, data: &[u8]) {
        #[tracing::instrument(level = "trace", ret(skip), skip(v,x))]
...
pub(crate) mod tests {
    ...
    impl DummyDevice {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,avail_features))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(d,status))]
