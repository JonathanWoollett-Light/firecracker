...
impl Entropy {
    #[tracing::instrument(level = "info", skip(rate_limiter))]
    ...
    #[tracing::instrument(level = "info", skip(queues, rate_limiter))]
    ...
    #[tracing::instrument(level = "info", skip(rate_limiter, bytes))]
    ...
    #[tracing::instrument(level = "info", skip(self, iovec))]
    ...
    #[tracing::instrument(level = "info", skip(self, features))]
...
impl VirtioDevice for Entropy {
    ...
    #[tracing::instrument(level = "info", skip(self, _offset, _data))]
...
mod tests {
    ...
    impl VirtioTestDevice for Entropy {
        #[tracing::instrument(level = "info", skip(self, queues))]
