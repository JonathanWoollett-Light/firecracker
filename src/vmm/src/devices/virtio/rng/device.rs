...
impl Entropy {
    #[tracing::instrument(level = "trace", ret(skip), skip(rate_limiter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(queues,rate_limiter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(rate_limiter,bytes))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,iovec))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,features))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,status))]
...
impl VirtioDevice for Entropy {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,_offset,_data))]
...
mod tests {
    ...
    impl VirtioTestDevice for Entropy {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,queues))]
