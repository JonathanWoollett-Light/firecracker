...
impl VsockChannel for VsockMuxer {
    #[tracing::instrument(level = "info", skip(self, pkt, mem))]
...
impl VsockMuxer {
    #[tracing::instrument(level = "info", skip(cid, host_sock_path))]
    /// Muxer constructor.
    ...
    #[tracing::instrument(level = "info", skip(self, fd, event_set))]
    ...
    #[tracing::instrument(level = "info", skip(self, key, conn))]
    ...
    #[tracing::instrument(level = "info", skip(self, fd, listener))]
    ...
    #[tracing::instrument(level = "info", skip(self, pkt))]
    ...
    #[tracing::instrument(level = "info", skip(self, key, mut_fn))]
    ...
    #[tracing::instrument(level = "info", skip(self, local_port, peer_port))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(fprefix))]
    ...
    impl MuxerTestContext {
        ...
        #[tracing::instrument(level = "info", skip(self, local_port, peer_port, op))]
        ...
        #[tracing::instrument(level = "info", skip(self, local_port, peer_port, data))]
        fn init_data_pkt(
            &mut self,
            local_port: u32,
            peer_port: u32,
        ...
        #[tracing::instrument(level = "info", skip(self, peer_port))]
