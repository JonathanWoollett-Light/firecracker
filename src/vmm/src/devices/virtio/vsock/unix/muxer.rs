...
impl VsockChannel for VsockMuxer {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,pkt,mem))]
...
impl VsockMuxer {
    #[tracing::instrument(level = "trace", ret(skip), skip(cid,host_sock_path))]
    /// Muxer constructor.
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,fd,event_set))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(stream))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,key,conn))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,fd,listener))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,fd))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,key,mut_fn))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,local_port,peer_port))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(fprefix))]
    ...
    impl MuxerTestContext {
        #[tracing::instrument(level = "trace", ret(skip), skip(name))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,peer_port))]
