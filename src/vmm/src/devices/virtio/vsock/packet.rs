...
impl VsockPacket {
    #[tracing::instrument(level = "trace", ret(skip), skip(desc,expected_write_only))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(hdr_desc,expected_write_only))]
    fn check_hdr_desc(
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,hdr_desc,expected_write_only))]
    fn init_buf(
        &mut self,
        hdr_desc: &DescriptorChain,
        expected_write_only: bool,
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(hdr_desc))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,buf_offset,count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,offset,src,count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,offset,dst,count))]
    ...
    #[tracing::instrument(level = "trace", skip(self,cid))]
    ...
    #[tracing::instrument(level = "trace", skip(self,flag))]
    ...
    #[tracing::instrument(level = "trace", skip(self,buf_alloc))]
    ...
    #[tracing::instrument(level = "trace", skip(self,fwd_cnt))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(len,guest_desc,mem))]
