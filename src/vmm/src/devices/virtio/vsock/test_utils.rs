...
impl TestBackend {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,err))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,prx))]
...
impl VsockChannel for TestBackend {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,_pkt,_mem))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(pkt,mem,how_much))]
#[cfg(test)]
...
{
    #[tracing::instrument(level = "trace", ret(skip), skip(vsock,idx,val))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vsock,idx))]
