    ...
    S: VsockConnectionBackend + Debug,
{
    ...
    #[tracing::instrument(level = "info", skip(self, evset))]
    ...
    S: VsockConnectionBackend + Debug,
{
    #[tracing::instrument(
        level = "trace",
        skip(stream, local_cid, peer_cid, local_port, peer_port, peer_buf_alloc)
    )]
    ...
    #[tracing::instrument(
        level = "trace",
        skip(stream, local_cid, peer_cid, local_port, peer_port)
    )]
    ...
    #[tracing::instrument(level = "info", skip(self, mem, pkt))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(pkt, op, len))]
    ...
    impl CsmTestContext {
        ...
        #[tracing::instrument(level = "info", skip(conn_state))]
        ...
        #[tracing::instrument(level = "info", skip(self, credit))]
        ...
        #[tracing::instrument(level = "info", skip(self, op, len))]
