...
impl Status {
    #[tracing::instrument(level = "trace", ret(skip), skip(data_len,transferred_data_len,data_to_mem))]
...
impl PendingRequest {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,status,mem))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,res))]
...
impl RequestHeader {
    #[tracing::instrument(level = "trace", ret(skip), skip(request_type,sector))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(memory,addr))]
...
impl Request {
    #[tracing::instrument(level = "trace", ret(skip), skip(avail_desc,mem,num_disk_sectors))]
    pub fn parse(
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,rate_limiter))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,desc_idx))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,disk,desc_idx,mem))]
...
mod tests {
    ...
    impl<'a, 'b> RequestDescriptorChain<'a, 'b> {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,_e))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,check_data))]
    ...
    impl From<RequestType> for u32 {
        #[tracing::instrument(level = "trace", ret(skip), skip(request_type))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(sparsity,data_len,sector,request_type,virtio_request_id,coins_arr))]
