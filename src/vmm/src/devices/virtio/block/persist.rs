...
impl From<CacheType> for CacheTypeState {
    #[tracing::instrument(level = "trace", ret(skip), skip(cache_type))]
...
impl From<CacheTypeState> for CacheType {
    #[tracing::instrument(level = "trace", ret(skip), skip(cache_type_state))]
...
impl From<FileEngineTypeState> for FileEngineType {
    #[tracing::instrument(level = "trace", ret(skip), skip(file_engine_type_state))]
