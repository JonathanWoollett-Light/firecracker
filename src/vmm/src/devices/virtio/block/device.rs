...
impl DiskProperties {
    #[tracing::instrument(level = "trace", ret(skip), skip(disk_image_path,is_disk_read_only,cache_type,file_engine_type))]
    pub fn new(
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(disk_file))]
...
impl Block {
    #[tracing::instrument(level = "trace", ret(skip), skip(id,partuuid,cache_type,disk_image_path,is_disk_read_only,is_disk_root,rate_limiter,file_engine_type))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(queue,index,len,mem,irq_trigger))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,queue_index))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,disk_image_path))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,bytes,ops))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,discard))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(block,vq,count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(count,vq))]
