...
#[tracing::instrument(level = "trace", ret(skip), skip(region_size))]
...
{
    #[tracing::instrument(level = "trace", ret(skip), skip(location,mem))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,val))]
...
impl<'a> VirtqDesc<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(start,mem))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,addr,len,flags,next))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,data))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,expected_data))]
...
where
    T: Debug + utils::vm_memory::ByteValued,
{
    #[tracing::instrument(level = "trace", ret(skip), skip(start,mem,qsize,alignment))]
...
impl<'a> VirtQueue<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(start,mem,qsize))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,used_index,expected_id,expected_len))]
...
pub(crate) mod test {
        ...
        T: VirtioTestDevice + MutEventSubscriber + Debug,
    {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(mem,num_queues))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(mem,device))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,mem))]
        /// Activate the device
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,queue,addr_offset,desc_list))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,msec))]
