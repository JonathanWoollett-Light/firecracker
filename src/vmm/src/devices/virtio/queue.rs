...
impl<'a> DescriptorChain<'a> {
    #[tracing::instrument(level = "trace", ret(skip), skip(mem,desc_table,queue_size,index))]
    fn checked_new(
        mem: &GuestMemoryMmap,
        desc_table: GuestAddress,
        queue_size: u16,
...
impl Queue {
    #[tracing::instrument(level = "trace", ret(skip), skip(max_size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,desc_index,len))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,val,mem))]
