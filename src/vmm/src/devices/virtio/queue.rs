...
impl<'a> DescriptorChain<'a> {
    #[tracing::instrument(level = "info", skip(mem, desc_table, queue_size, index))]
    fn checked_new(
        mem: &GuestMemoryMmap,
        desc_table: GuestAddress,
        queue_size: u16,
...
impl Queue {
    ...
    #[tracing::instrument(level = "info", skip(self, mem, desc_index, len))]
    ...
    #[tracing::instrument(level = "info", skip(self, val, mem))]
