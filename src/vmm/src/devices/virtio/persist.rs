...
impl VirtioDeviceState {
    #[tracing::instrument(level = "trace", skip(device))]
    ...
    #[tracing::instrument(level = "trace", skip(self,mem,expected_device_type,expected_num_queues,expected_queue_max_size))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", skip(mmio_transport,mem,device))]
