...
impl VirtioDeviceState {
    #[tracing::instrument(level = "trace", ret(skip), skip(device))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,mem,expected_device_type,expected_num_queues,expected_queue_max_size))]
...
impl Persist<'_> for MmioTransport {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(constructor_args,state))]
    fn restore(
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(mmio_transport,mem,device))]
