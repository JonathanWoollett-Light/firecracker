...
impl VmInfo {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,_target_version))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,vm_info,params,version_map))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(microvm_state,snapshot_path,snapshot_data_version,version_map))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,mem_file_path,snapshot_type))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(maybe_fc_version,version_map,vmm))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(microvm_state))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(instance_info,event_manager,seccomp_filters,params,version_map,vm_resources))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(snapshot_path,version_map))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem_file_path,mem_state,track_dirty_pages))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem_uds_path,mem_state,track_dirty_pages,enable_balloon))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(device_number))]
#[cfg(target_arch = "x86_64")]
