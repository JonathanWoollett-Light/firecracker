...
#[tracing::instrument(level = "trace", skip(microvm_state,snapshot_path,snapshot_data_version,version_map))]
...
#[tracing::instrument(level = "trace", skip(instance_info,event_manager,seccomp_filters,params,version_map,vm_resources))]
...
#[tracing::instrument(level = "trace", skip(mem_uds_path,mem_state,track_dirty_pages,enable_balloon))]
