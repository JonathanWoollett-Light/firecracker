...
impl IoUring {
    #[tracing::instrument(level = "trace", ret(skip), skip(num_entries,files,restrictions,eventfd))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,op))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,min_complete))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,files))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,restrictions))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(params))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(ring))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(len))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(region))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(file_len))]
