...
impl MMIODeviceManager {
    #[tracing::instrument(level = "info", skip(mmio_base, mmio_size))]
    ...
    #[tracing::instrument(level = "info", skip(self, irq_count))]
    ...
    #[tracing::instrument(level = "info", skip(self, identifier, device_info, device))]
    ...
    #[tracing::instrument(level = "info", skip(self, vm, device_id, mmio_device, device_info))]
    ...
    #[tracing::instrument(level = "info", skip(cmdline, device_info))]
    ...
    #[tracing::instrument(level = "info", skip(self, vm, device_id, mmio_device, _cmdline))]
    ...
    #[tracing::instrument(level = "info", skip(self, vm, serial, device_info_opt))]
    #[cfg(target_arch = "aarch64")]
    ...
    #[tracing::instrument(level = "info", skip(self, cmdline))]
    #[cfg(target_arch = "aarch64")]
    ...
    #[tracing::instrument(level = "info", skip(self, rtc, device_info_opt))]
    #[cfg(target_arch = "aarch64")]
    ...
    #[tracing::instrument(level = "info", skip(self, device_type, device_id))]
    ...
    #[tracing::instrument(level = "info", skip(self, virtio_type, id, f))]
...
mod tests {
    ...
    impl MMIODeviceManager {
        #[tracing::instrument(level = "info", skip(self, vm, guest_mem, device, cmdline, dev_id))]
    ...
    impl crate::devices::virtio::VirtioDevice for DummyDevice {
        ...
        #[tracing::instrument(level = "info", skip(self, page, value))]
        fn ack_features_by_page(&mut self, page: u32, value: u32) {
            let _ = page;
            let _ = value;
        }

        #[tracing::instrument(level = "info", skip(self, offset, data))]
