...
use crate::vstate::vm::{RestoreStateError, Vm};
use crate::{
    device_manager, EmulateSerialInitError, Error, EventManager, RestoreVcpusError,
    StartVcpusError, Vmm, VmmEventsObserver,
};
...
pub enum BuildMicrovmFromSnapshotError {
    ...
    CpuidNewError(#[from] cpuid::CpuidFromRawCpuidError),
