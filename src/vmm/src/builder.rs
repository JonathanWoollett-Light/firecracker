...
impl std::convert::From<linux_loader::cmdline::Error> for StartMicrovmError {
    #[tracing::instrument(level = "trace", ret(skip), skip(err))]
    fn from(err: linux_loader::cmdline::Error) -> StartMicrovmError {
        StartMicrovmError::KernelCmdline(err.to_string())
    }
}

#[tracing::instrument(level = "trace", ret(skip), skip(instance_info,event_manager,guest_memory,uffd,track_dirty_pages,vcpu_count))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(instance_info,vm_resources,event_manager,seccomp_filters))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(instance_info,event_manager,microvm_state,guest_memory,uffd,track_dirty_pages,seccomp_filters,vm_resources))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem_size_mib,track_dirty_pages))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(boot_config,guest_memory))]
fn load_kernel(
...
#[tracing::instrument(level = "trace", ret(skip), skip(boot_cfg,vm_memory))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vm_memory,image))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(guest_memory,track_dirty_pages))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vm))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vm,vcpu_count))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(event_manager,input,out))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(event_manager,vmm,cmdline))]
#[cfg(target_arch = "aarch64")]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vm,vcpu_count,exit_evt))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,vcpus,vm_config,entry_addr,initrd,boot_cmdline))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(event_manager,vmm,id,device,cmdline))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,request_ts))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,entropy_device,event_manager))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,blocks,event_manager))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,net_devices,event_manager))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,unix_vsock,event_manager))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,balloon,event_manager))]
...
pub mod tests {
    ...
    impl CustomBlockConfig {
        #[tracing::instrument(level = "trace", ret(skip), skip(drive_id,is_root_device,partuuid,is_read_only,cache_type))]
        pub(crate) fn new(
            drive_id: String,
            is_root_device: bool,
            partuuid: Option<String>,
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(cmdline,slug))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,custom_block_cfgs))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,net_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,net_config,mmds_version))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,vsock_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,entropy_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm,cmdline,event_manager,balloon_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(at,size))]
