...
impl CacheStore for HostCacheStore {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,index,file_name))]
    fn get_by_key(&self, index: u8, file_name: &str) -> Result<String, CacheInfoError> {
...
impl CacheEntry {
    #[tracing::instrument(level = "trace", ret(skip), skip(index,store))]
...
impl CacheType {
    #[tracing::instrument(level = "trace", ret(skip), skip(string))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(cache_size_pretty))]
...
//
#[tracing::instrument(level = "trace", ret(skip), skip(mask_str))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(cache_l1,cache_non_l1,cache))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(cache_l1,cache_non_l1))]
...
mod tests {
    ...
    impl CacheEngine {
        #[tracing::instrument(level = "trace", ret(skip), skip(map))]
