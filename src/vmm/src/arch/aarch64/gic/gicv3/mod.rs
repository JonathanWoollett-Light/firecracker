...
impl GICv3 {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vcpu_count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(fd,vcpu_count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(fd,group,attr,addr,flags))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fd))]
