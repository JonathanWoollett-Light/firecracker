...
#[tracing::instrument(level = "trace", ret(skip), skip(fd,mpidr))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(reg,num_priority_bits))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fd,mpidr,state))]
