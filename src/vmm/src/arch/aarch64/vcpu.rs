...
#[tracing::instrument(level = "info", skip(regs))]
...
#[tracing::instrument(level = "info", skip(vcpufd, cpu_id, boot_ip, mem))]
...
#[tracing::instrument(level = "info", skip(vcpufd))]
...
#[tracing::instrument(level = "info", skip(vcpufd, state))]
...
#[tracing::instrument(level = "info", skip(vcpufd, ids, regs))]
...
#[tracing::instrument(level = "info", skip(vcpufd, regs))]
