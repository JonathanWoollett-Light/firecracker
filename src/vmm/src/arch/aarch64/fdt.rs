...
#[tracing::instrument(level = "info", skip(fdt, vcpu_mpidr))]
...
#[tracing::instrument(level = "info", skip(fdt, guest_mem))]
...
#[tracing::instrument(level = "info", skip(fdt, cmdline, initrd))]
...
#[tracing::instrument(level = "info", skip(fdt, gic_device))]
...
#[tracing::instrument(level = "info", skip(fdt))]
...
#[tracing::instrument(level = "info", skip(fdt, dev_info))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(buf, pos, val))]
