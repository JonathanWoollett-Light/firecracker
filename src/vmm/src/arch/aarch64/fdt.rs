...
#[tracing::instrument(level = "trace", ret(skip), skip(guest_mem,vcpu_mpidr,cmdline,device_info,gic_device,initrd))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt,vcpu_mpidr))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt,guest_mem))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt,cmdline,initrd))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt,gic_device))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(fdt,dev_info))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(buf,pos,val))]
