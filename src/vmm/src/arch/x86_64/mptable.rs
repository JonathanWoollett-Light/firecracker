...
#[tracing::instrument(level = "trace", ret(skip), skip(v))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(num_cpus))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem,num_cpus))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(type_))]
