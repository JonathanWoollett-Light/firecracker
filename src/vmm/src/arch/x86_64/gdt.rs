...
#[tracing::instrument(level = "trace", ret(skip), skip(flags,base,limit))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(entry))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(entry,table_index))]
