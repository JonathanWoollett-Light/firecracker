...
impl MsrRange {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,msr))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(index))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(kvm_fd))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vcpu,msr_entries))]
