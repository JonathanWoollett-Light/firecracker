...
#[tracing::instrument(level = "trace", ret(skip), skip(vcpu))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(vcpu,boot_ip))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem,vcpu))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(table,guest_mem))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(val,guest_mem))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem,sregs))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(gm,offset))]
    fn read_u64(gm: &GuestMemoryMmap, offset: u64) -> u64 {
        let read_addr = GuestAddress(offset);
        gm.read_obj(read_addr).unwrap()
    }

    #[tracing::instrument(level = "trace", ret(skip), skip(gm,sregs))]
