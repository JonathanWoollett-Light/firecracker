...
#[tracing::instrument(level = "info", skip(klapic, reg_offset))]
...
#[tracing::instrument(level = "info", skip(klapic, reg_offset, value))]
...
#[tracing::instrument(level = "info", skip(reg, mode))]
