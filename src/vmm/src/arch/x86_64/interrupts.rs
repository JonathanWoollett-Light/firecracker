...
#[tracing::instrument(level = "trace", ret(skip), skip(klapic,reg_offset))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(klapic,reg_offset,value))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(reg,mode))]
