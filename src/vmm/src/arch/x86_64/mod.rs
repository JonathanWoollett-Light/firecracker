...
#[tracing::instrument(level = "trace", ret(skip), skip(guest_mem,initrd_size))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(guest_mem,cmdline_addr,cmdline_size,initrd,num_cpus))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(params,addr,size,mem_type))]
