    ...
    PrebootApiController<'a, F, G>
{
    ...
    #[tracing::instrument(level = "info", skip(self, cfg))]
    ...
    #[tracing::instrument(level = "info", skip(self, cpu_template))]
    ...
    // On success, this command will end the pre-boot stage and this controller
    // will be replaced by a runtime controller.
    #[tracing::instrument(level = "info", skip(self, load_params))]
    fn load_snapshot(
        &mut self,
...
impl RuntimeApiController {
    ...
    #[tracing::instrument(level = "info", skip(vm_resources, vmm))]
    ...
    #[tracing::instrument(level = "info", skip(self, create_params))]
    fn create_snapshot(
        &mut self,
    ...
    #[tracing::instrument(level = "info", skip(self, new_cfg))]
...
mod tests {
    ...
    impl MockVmRes {
        ...
        #[tracing::instrument(level = "info", skip(self, dirty_page_tracking))]
        ...
        #[tracing::instrument(level = "info", skip(self, boot_source))]
        ...
        #[tracing::instrument(level = "info", skip(self, mmds_config))]
    ...
    #[tracing::instrument(level = "info", skip(request, check_success))]
    ...
    #[tracing::instrument(level = "info", skip(request, mmds, check_success))]
