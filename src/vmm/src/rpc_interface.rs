...
impl<'a> PrebootApiController<'a> {
    #[tracing::instrument(level = "trace", ret(skip), skip(seccomp_filters,instance_info,vm_resources,event_manager,logger_handles))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(seccomp_filters,event_manager,instance_info,from_api,to_api,api_event_fd,boot_timer_enabled,mmds_size_limit,metadata_json,logger_handles))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,request))]
    ...
    // On success, this command will end the pre-boot stage and this controller
    // will be replaced by a runtime controller.
    #[tracing::instrument(level = "trace", ret(skip), skip(self,load_params))]
    fn load_snapshot(
        &mut self,
...
impl RuntimeApiController {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vm_resources,vmm))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,create_params))]
    fn create_snapshot(
        &mut self,
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,new_cfg))]
...
mod tests {
    ...
    impl PartialEq for VmmActionError {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,other))]
    ...
    impl MockVmRes {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,dirty_page_tracking))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,boot_source))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,mmds_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(request,check_success))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(request,mmds,check_success))]
