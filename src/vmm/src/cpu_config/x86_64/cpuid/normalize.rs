...
#[tracing::instrument(level = "trace", ret(skip), skip(x,bit,y))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(x,range,y))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(x,range))]
...
impl super::Cpuid {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_index,cpu_count,cpu_bits))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_index,cpu_count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_index,cpu_count,cpu_bits,cpus_per_core))]
