...
impl super::AmdCpuid {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_index,cpu_count,cpus_per_core))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_count))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_count,cpus_per_core))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,cpu_index,cpus_per_core))]
