...
impl VmResources {
    #[tracing::instrument(level = "trace", ret(skip), skip(config_json,instance_info,mmds_size_limit,metadata_json))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,boot_source_cfg))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,block_device_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,body))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,config,instance_id))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,version,instance_id))]
...
impl From<&VmResources> for VmmConfig {
    #[tracing::instrument(level = "trace", ret(skip), skip(resources))]
