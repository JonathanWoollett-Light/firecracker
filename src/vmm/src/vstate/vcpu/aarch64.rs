...
impl KvmVcpu {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,guest_mem,kernel_load_addr,vcpu_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,vm_fd))]
...
impl VcpuState {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,_source_version))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vcpu,vm))]
