...
impl KvmVcpu {
    ...
    #[tracing::instrument(level = "info", skip(self, guest_mem, kernel_load_addr, vcpu_config))]
    ...
    #[tracing::instrument(level = "info", skip(self, vm_fd))]
...
impl VcpuState {
    ...
    #[tracing::instrument(level = "info", skip(self, _source_version))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(vcpu, vm))]
