...
impl KvmVcpu {
    #[tracing::instrument(level = "info", skip(index, vm))]
    ...
    #[tracing::instrument(level = "info", skip(self, guest_mem, kernel_start_addr, vcpu_config))]
    ...
    #[tracing::instrument(level = "info", skip(self, pio_bus))]
    ...
    #[tracing::instrument(level = "info", skip(self, msr_index_list))]
    ...
    #[tracing::instrument(level = "info", skip(self, state_tsc_freq))]
    ...
    #[tracing::instrument(level = "info", skip(self, tsc_freq))]
    ...
    #[tracing::instrument(level = "info", skip(self, exit))]
...
impl VcpuState {
    ...
    #[tracing::instrument(level = "info", skip(self, _target_version))]
    ...
    #[tracing::instrument(level = "info", skip(self, source_version))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(vm, vcpu, template))]
