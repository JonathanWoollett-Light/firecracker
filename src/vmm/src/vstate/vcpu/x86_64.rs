...
impl KvmVcpu {
    #[tracing::instrument(level = "trace", ret(skip), skip(index,vm))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,guest_mem,kernel_start_addr,vcpu_config))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,pio_bus))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,msr_index_list))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,state_tsc_freq))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tsc_freq))]
    pub fn set_tsc_khz(&self, tsc_freq: u32) -> Result<(), SetTscError> {
        self.fd.set_tsc_khz(tsc_freq).map_err(SetTscError)
    }

    #[tracing::instrument(level = "trace", ret(skip), skip(self,state))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,exit))]
...
impl VcpuState {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,source_version))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(mem_size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vm,vcpu,template))]
