...
impl Vm {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,guest_mem,kvm_max_memslots,track_dirty_pages))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,guest_mem,track_dirty_pages))]
...
#[cfg(target_arch = "aarch64")]
impl Vm {
    #[tracing::instrument(level = "trace", ret(skip), skip(kvm))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,vcpu_count))]
