...
#[tracing::instrument(level = "info", skip(x, y))]
...
impl TokenBucket {
    #[tracing::instrument(level = "info", skip(size, one_time_burst, complete_refill_time_ms))]
    ...
    #[tracing::instrument(level = "info", skip(self, tokens))]
...
impl RateLimiter {
    ...
    #[tracing::instrument(level = "info", skip(self, timer_state))]
    ...
    #[tracing::instrument(level = "info", skip(self, tokens, token_type))]
...
mod verification {
    ...
    mod stubs {
        ...
        #[tracing::instrument(level = "info", skip(this))]
...
pub(crate) mod tests {
    ...
    impl RateLimiter {
        #[tracing::instrument(level = "info", skip(self, token_type))]
