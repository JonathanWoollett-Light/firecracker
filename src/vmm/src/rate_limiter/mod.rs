...
#[tracing::instrument(level = "trace", ret(skip), skip(x,y))]
...
impl TokenBucket {
    #[tracing::instrument(level = "trace", ret(skip), skip(size,one_time_burst,complete_refill_time_ms))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tokens))]
...
impl RateLimiter {
    #[tracing::instrument(level = "trace", ret(skip), skip(bytes_total_capacity,bytes_one_time_burst,bytes_complete_refill_time_ms,ops_total_capacity,ops_one_time_burst,ops_complete_refill_time_ms))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,timer_state))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tokens,token_type))]
...
mod verification {
    ...
    mod stubs {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(this))]
...
pub(crate) mod tests {
    ...
    impl RateLimiter {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,token_type))]
