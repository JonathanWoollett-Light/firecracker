...
impl From<&Block> for BlockDeviceConfig {
    #[tracing::instrument(level = "trace", ret(skip), skip(block))]
...
impl BlockBuilder {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,drive_id))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,block_device))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(block_device_config))]
