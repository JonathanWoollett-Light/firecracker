...
impl BlockBuilder {
    ...
    #[tracing::instrument(level = "info", skip(self, drive_id))]
    ...
    #[tracing::instrument(level = "info", skip(self, block_device))]
    ...
    #[tracing::instrument(level = "info", skip(block_device_config))]
