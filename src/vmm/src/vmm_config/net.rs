...
impl From<&Net> for NetworkInterfaceConfig {
    #[tracing::instrument(level = "trace", ret(skip), skip(net))]
...
impl NetBuilder {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,netif_config))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(id,name,mac))]
