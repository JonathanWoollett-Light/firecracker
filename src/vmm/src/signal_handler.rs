...
#[tracing::instrument(level = "info", skip(exit_code))]
#[inline]
...
#[tracing::instrument(level = "info", skip(si_code, info))]
...
#[tracing::instrument(level = "info", skip(_si_code, _info))]
...
#[tracing::instrument(level = "info", skip(num, info, _unused))]
#[inline(always)]
