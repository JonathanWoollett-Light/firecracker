...
use cpuid::intel::*;
use cpuid::{Cpuid, FixedString};
lazy_static::lazy_static! { pub static ref C3 : Cpuid = include ! ("c3.in") ; pub static ref T2 : Cpuid = include ! ("t2.in") ; pub static ref T2S : Cpuid = include ! ("t2s.in") ; }
#[cfg(test)]
mod tests {
    use cpuid::Cpuid;
