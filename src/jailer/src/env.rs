...
#[tracing::instrument(level = "info", skip(old_fd, new_fd))]
...
#[tracing::instrument(level = "info", skip(child_stack, flags))]
...
impl Env {
    #[tracing::instrument(level = "info", skip(arguments, start_time_us, start_time_cpu_us))]
    pub fn new(
    ...
    #[tracing::instrument(level = "info", skip(exec_file))]
    ...
    #[tracing::instrument(level = "info", skip(resource_limits, args))]
    ...
    #[tracing::instrument(level = "info", skip(self, chroot_exec_file))]
    ...
    #[tracing::instrument(level = "info", skip(self, pid, chroot_exec_file))]
    ...
    #[tracing::instrument(level = "info", skip(self, dev_path_str, dev_major, dev_minor))]
    ...
    #[tracing::instrument(level = "info", skip(self, folder))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(arg_vals))]
    ...
    #[tracing::instrument(level = "info", skip(dev))]
