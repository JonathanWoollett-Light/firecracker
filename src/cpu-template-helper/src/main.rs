...
#[tracing::instrument(level = "trace", ret(skip), skip(cli))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(kernel_image_path,rootfs_path))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(kernel_image_path,rootfs_path,cpu_template_path))]
