...
impl<'a> ArgParser<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,argument))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,is_required))]
...
impl<'a> Argument<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,required))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,other_arg))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,args))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,takes_value))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,allow_multiple))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,default_value))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,help))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,arg_width))]
...
impl<'a> Arguments<'a> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,arg_name))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(args))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,arg))]
