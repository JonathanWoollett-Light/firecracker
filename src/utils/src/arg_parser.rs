...
impl<'a> ArgParser<'a> {
    ...
    #[tracing::instrument(level = "info", skip(self, argument))]
    ...
    #[tracing::instrument(level = "info", skip(self, is_required))]
...
impl<'a> Argument<'a> {
    ...
    #[tracing::instrument(level = "info", skip(self, required))]
    ...
    #[tracing::instrument(level = "info", skip(self, other_arg))]
    ...
    #[tracing::instrument(level = "info", skip(self, takes_value))]
    ...
    #[tracing::instrument(level = "info", skip(self, allow_multiple))]
    ...
    #[tracing::instrument(level = "info", skip(self, default_value))]
    ...
    #[tracing::instrument(level = "info", skip(self, help))]
    ...
    #[tracing::instrument(level = "info", skip(self, arg_width))]
...
impl<'a> Arguments<'a> {
    ...
    #[tracing::instrument(level = "info", skip(self, arg_name))]
    ...
    #[tracing::instrument(level = "info", skip(self, arg))]
