...
impl<'a> ArgParser<'a> {
    ...
    #[tracing::instrument(level = "trace", skip(self,argument))]
    ...
    #[tracing::instrument(level = "trace", skip(self,is_required))]
...
impl<'a> Argument<'a> {
    ...
    #[tracing::instrument(level = "trace", skip(self,required))]
    ...
    #[tracing::instrument(level = "trace", skip(self,other_arg))]
    ...
    #[tracing::instrument(level = "trace", skip(self,takes_value))]
    ...
    #[tracing::instrument(level = "trace", skip(self,allow_multiple))]
    ...
    #[tracing::instrument(level = "trace", skip(self,default_value))]
    ...
    #[tracing::instrument(level = "trace", skip(self,help))]
    ...
    #[tracing::instrument(level = "trace", skip(self,arg_width))]
...
impl<'a> Arguments<'a> {
    ...
    #[tracing::instrument(level = "trace", skip(self,arg_name))]
    ...
    #[tracing::instrument(level = "trace", skip(self,arg))]
