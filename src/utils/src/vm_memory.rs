...
#[tracing::instrument(level = "trace", ret(skip), skip(maybe_file_offset,size,prot,flags,track_dirty_pages))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(regions,track_dirty_pages))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mem,addr,len))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(raw_fd,buf))]
...
mod tests {
    ...
    impl AddrOp {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,addr))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(function,expect_sigsegv))]
