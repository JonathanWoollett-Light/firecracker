...
mod tests {
    ...
    bitfield!(BitFieldNonZeroU128, NonZeroU128, {
        one: 0..1,
        two: 1..3,
        three: 3..6,
        four: 6..10,
    ...
    bitfield!(BitFieldNonZeroU64, NonZeroU64, {
        one: 0..1,
        two: 1..3,
        three: 3..6,
        four: 6..10,
    ...
    bitfield!(BitFieldNonZeroU32, NonZeroU32, {
        one: 0..1,
        two: 1..3,
        three: 3..6,
        four: 6..10,
    ...
    bitfield!(BitFieldNonZeroU16, NonZeroU16, {
        one: 0..1,
        two: 1..3,
        three: 3..6,
        four: 6..10,
    ...
    bitfield!(BitFieldNonZeroU8, NonZeroU8, {
        one: 0..1,
        two: 1..3,
        three: 3..6,
        four: 6,
    ...
    fn size() {
        ...
        assert_eq!(size_of::<BitFieldNonZeroU128>(), size_of::<u128>());
        assert_eq!(size_of::<BitFieldNonZeroU64>(), size_of::<u64>());
        assert_eq!(size_of::<BitFieldNonZeroU32>(), size_of::<u32>());
        assert_eq!(size_of::<BitFieldNonZeroU16>(), size_of::<u16>());
        assert_eq!(size_of::<BitFieldNonZeroU8>(), size_of::<u8>());

        assert_eq!(size_of::<Option<BitFieldNonZeroU128>>(), size_of::<u128>());
        assert_eq!(size_of::<Option<BitFieldNonZeroU64>>(), size_of::<u64>());
        assert_eq!(size_of::<Option<BitFieldNonZeroU32>>(), size_of::<u32>());
        assert_eq!(size_of::<Option<BitFieldNonZeroU16>>(), size_of::<u16>());
        assert_eq!(size_of::<Option<BitFieldNonZeroU8>>(), size_of::<u8>());
    }
    #[test]
    fn type_max() {
        // u128
    ...
    fn type_max_nonzero() {
        // u128
        assert_eq!(
            BitRange::<NonZeroU128, 0, 1>::MAX,
            NonZeroU128::new(1).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 1, 3>::MAX,
            NonZeroU128::new(3).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 3, 6>::MAX,
            NonZeroU128::new(7).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 6, 10>::MAX,
            NonZeroU128::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 10, 15>::MAX,
            NonZeroU128::new(31).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 15, 21>::MAX,
            NonZeroU128::new(63).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 21, 28>::MAX,
            NonZeroU128::new(127).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 28, 36>::MAX,
            NonZeroU128::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 36, 45>::MAX,
            NonZeroU128::new(511).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 45, 55>::MAX,
            NonZeroU128::new(1023).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 55, 66>::MAX,
            NonZeroU128::new(2047).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 66, 78>::MAX,
            NonZeroU128::new(4095).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 78, 91>::MAX,
            NonZeroU128::new(8191).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 91, 105>::MAX,
            NonZeroU128::new(16383).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU128, 105, 120>::MAX,
            NonZeroU128::new(32767).unwrap()
        );

        // u64
        assert_eq!(
            BitRange::<NonZeroU64, 0, 1>::MAX,
            NonZeroU64::new(1).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 1, 3>::MAX,
            NonZeroU64::new(3).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 3, 6>::MAX,
            NonZeroU64::new(7).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 6, 10>::MAX,
            NonZeroU64::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 10, 15>::MAX,
            NonZeroU64::new(31).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 15, 21>::MAX,
            NonZeroU64::new(63).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 21, 28>::MAX,
            NonZeroU64::new(127).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 28, 36>::MAX,
            NonZeroU64::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 36, 45>::MAX,
            NonZeroU64::new(511).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU64, 45, 55>::MAX,
            NonZeroU64::new(1023).unwrap()
        );

        // u32
        assert_eq!(
            BitRange::<NonZeroU32, 0, 1>::MAX,
            NonZeroU32::new(1).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 1, 3>::MAX,
            NonZeroU32::new(3).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 3, 6>::MAX,
            NonZeroU32::new(7).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 6, 10>::MAX,
            NonZeroU32::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 10, 15>::MAX,
            NonZeroU32::new(31).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 15, 21>::MAX,
            NonZeroU32::new(63).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU32, 21, 28>::MAX,
            NonZeroU32::new(127).unwrap()
        );

        // u16
        assert_eq!(
            BitRange::<NonZeroU16, 0, 1>::MAX,
            NonZeroU16::new(1).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 1, 3>::MAX,
            NonZeroU16::new(3).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 3, 6>::MAX,
            NonZeroU16::new(7).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 6, 10>::MAX,
            NonZeroU16::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 10, 15>::MAX,
            NonZeroU16::new(31).unwrap()
        );

        assert_eq!(
            BitRange::<NonZeroU16, 0, 16>::MAX,
            NonZeroU16::new(65535).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 0, 8>::MAX,
            NonZeroU16::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 8, 16>::MAX,
            NonZeroU16::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 4, 12>::MAX,
            NonZeroU16::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU16, 6, 10>::MAX,
        ...
        assert_eq!(
            BitRange::<NonZeroU16, 7, 9>::MAX,
            NonZeroU16::new(3).unwrap()
        );

        // u8
        assert_eq!(BitRange::<NonZeroU8, 0, 1>::MAX, NonZeroU8::new(1).unwrap());
        assert_eq!(BitRange::<NonZeroU8, 1, 3>::MAX, NonZeroU8::new(3).unwrap());
        assert_eq!(BitRange::<NonZeroU8, 3, 6>::MAX, NonZeroU8::new(7).unwrap());

        assert_eq!(
            BitRange::<NonZeroU8, 0, 8>::MAX,
            NonZeroU8::new(255).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU8, 0, 4>::MAX,
            NonZeroU8::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU8, 4, 8>::MAX,
            NonZeroU8::new(15).unwrap()
        );
        assert_eq!(
            BitRange::<NonZeroU8, 2, 6>::MAX,
            NonZeroU8::new(15).unwrap()
        );
        assert_eq!(BitRange::<NonZeroU8, 3, 5>::MAX, NonZeroU8::new(3).unwrap());
    }
    #[test]
    fn value_max() {
