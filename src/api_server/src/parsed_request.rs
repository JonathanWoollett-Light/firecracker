...
impl ParsingInfo {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,message))]
...
impl TryFrom<&Request> for ParsedRequest {
    type Error = Error;
    #[tracing::instrument(level = "trace", ret(skip), skip(request))]
...
impl ParsedRequest {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(body_data))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(request_outcome))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(vmm_action))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(api_description))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(method,path,body))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(method,path,payload_value))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(method))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(id))]
...
pub mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(req))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(req,msg))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(body,status_code))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(request_type,endpoint,body))]
