...
impl<T: Serialize + Debug, M: Write + Send + Debug> Metrics<T, M> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,metrics_dest))]
...
impl ProcessTimeReporter {
    #[tracing::instrument(level = "trace", ret(skip), skip(start_time_us,start_time_cpu_us,parent_cpu_time_us))]
