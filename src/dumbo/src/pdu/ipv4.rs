...
impl<'a, T: NetworkBytes + Debug> IPv4Packet<'a, T> {
    ...
    #[inline]
    #[tracing::instrument(level = "debug", skip(self, header_len))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, header_len))]
...
impl<'a, T: NetworkBytesMut + Debug> IPv4Packet<'a, T> {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(buf, protocol, src_addr, dst_addr))]
    pub fn write_header(
        buf: T,
        protocol: u8,
        src_addr: Ipv4Addr,
    ...
    /// value of `header_len`).
    #[inline]
    #[tracing::instrument(level = "debug", skip(self, version, header_len))]
    ...
    #[inline]
    #[tracing::instrument(level = "debug", skip(self, dscp, ecn))]
    ...
    #[inline]
    #[tracing::instrument(level = "debug", skip(self, flags, fragment_offset))]
...
impl<'a, T: NetworkBytesMut + Debug> Incomplete<IPv4Packet<'a, T>> {
    ...
    #[tracing::instrument(
        level = "debug",
        ret(skip),
        skip(self, header_len, payload_len, compute_checksum)
    )]
    ...
    #[tracing::instrument(
        level = "debug",
        ret(skip),
        skip(self, options_len, payload_len, compute_checksum)
    )]
    ...
    /// This method may panic if the value of `header_len` is invalid.
    #[inline]
    #[tracing::instrument(level = "debug", ret(skip), skip(self, payload_len, compute_checksum))]
