...
impl<'a, T: NetworkBytesMut + Debug> IPv4Packet<'a, T> {
    #[tracing::instrument(level = "trace", ret(skip), skip(buf,protocol,src_addr,dst_addr))]
...
impl<'a, T: NetworkBytesMut + Debug> Incomplete<IPv4Packet<'a, T>> {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,header_len,payload_len,compute_checksum))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,options_len,payload_len,compute_checksum))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,payload_len,compute_checksum))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(buf,addr))]
