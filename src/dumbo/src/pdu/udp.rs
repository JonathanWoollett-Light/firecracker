...
impl<'a, T: NetworkBytes + Debug> UdpDatagram<'a, T> {
    ...
    #[tracing::instrument(level = "info", skip(self, src_addr, dst_addr))]
...
impl<'a, T: NetworkBytesMut + Debug> UdpDatagram<'a, T> {
    #[tracing::instrument(level = "info", skip(buf, payload))]
    ...
    #[tracing::instrument(level = "info", skip(self, src_port))]
    ...
    #[tracing::instrument(level = "info", skip(self, dst_port))]
    ...
    #[tracing::instrument(level = "info", skip(self, checksum))]
...
impl<'a, T: NetworkBytesMut + Debug> Incomplete<UdpDatagram<'a, T>> {
    #[tracing::instrument(level = "info", skip(self, src_port, dst_port, compute_checksum))]
