...
impl<'a, T: NetworkBytes + Debug> TcpSegment<'a, T> {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,src_addr,dst_addr))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,header_len))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(bytes))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(bytes,verify_checksum))]
...
impl<'a, T: NetworkBytesMut + Debug> TcpSegment<'a, T> {
    ...
    #[tracing::instrument(level = "trace", skip(self,header_len,ns))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(buf,src_port,dst_port,seq_number,ack_number,flags_after_ns,window_size,mss_option,mss_remaining,payload,compute_checksum))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(buf,seq_number,ack_number,flags_after_ns,window_size,mss_option,mss_remaining,payload))]
...
impl<'a, T: NetworkBytesMut + Debug> Incomplete<TcpSegment<'a, T>> {
    #[tracing::instrument(level = "trace", ret(skip), skip(self,src_port,dst_port,compute_checksum))]
