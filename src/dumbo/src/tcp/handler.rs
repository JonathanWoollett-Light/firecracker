...
impl ConnectionTuple {
    #[tracing::instrument(level = "debug", ret(skip), skip(remote_addr, remote_port))]
...
impl TcpIPv4Handler {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, ipv4_addr))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, packet, callback))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, value, tuple))]
    ...
    // been there already).
    #[tracing::instrument(level = "debug", ret(skip), skip(self, tuple, status))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, tuple, endpoint))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, tuple))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, tuple, cfg))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, tuple, s))]
...
mod tests {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(h, buf))]
    fn write_next<'a>(
    ...
    #[tracing::instrument(level = "debug", skip(h, buf, expected_event))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(h, src_addr, remote_addr))]
    fn drain_packets(
        h: &mut TcpIPv4Handler,
        src_addr: Ipv4Addr,
        remote_addr: Ipv4Addr,
