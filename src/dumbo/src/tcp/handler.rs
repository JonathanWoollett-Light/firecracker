...
impl ConnectionTuple {
    #[tracing::instrument(level = "trace", ret(skip), skip(remote_addr,remote_port))]
...
impl TcpIPv4Handler {
    #[tracing::instrument(level = "trace", ret(skip), skip(local_ipv4_addr,local_port,max_connections,max_pending_resets))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,ipv4_addr))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,packet,callback))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,value,tuple))]
    ...
    // been there already).
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tuple,status))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tuple,endpoint))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tuple))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tuple,cfg))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,tuple,s))]
...
mod tests {
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(p))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(h,buf))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(h,buf,expected_event))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(h,src_addr,remote_addr))]
    fn drain_packets(
        h: &mut TcpIPv4Handler,
        src_addr: Ipv4Addr,
        remote_addr: Ipv4Addr,
