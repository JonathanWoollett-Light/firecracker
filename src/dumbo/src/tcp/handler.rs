...
impl ConnectionTuple {
    #[tracing::instrument(level = "info", skip(remote_addr, remote_port))]
...
impl TcpIPv4Handler {
    ...
    #[tracing::instrument(level = "info", skip(self, ipv4_addr))]
    ...
    #[tracing::instrument(level = "info", skip(self, packet, callback))]
    ...
    #[tracing::instrument(level = "info", skip(self, value, tuple))]
    ...
    // been there already).
    #[tracing::instrument(level = "info", skip(self, tuple, status))]
    ...
    #[tracing::instrument(level = "info", skip(self, tuple, endpoint))]
    ...
    #[tracing::instrument(level = "info", skip(self, tuple))]
    ...
    #[tracing::instrument(level = "info", skip(self, tuple, cfg))]
    ...
    #[tracing::instrument(level = "info", skip(self, tuple, s))]
...
mod tests {
    ...
    #[tracing::instrument(level = "info", skip(h, buf))]
    ...
    #[tracing::instrument(level = "info", skip(h, buf, expected_event))]
    ...
    #[tracing::instrument(level = "info", skip(h, src_addr, remote_addr))]
    fn drain_packets(
        h: &mut TcpIPv4Handler,
        src_addr: Ipv4Addr,
        remote_addr: Ipv4Addr,
