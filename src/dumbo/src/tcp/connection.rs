...
#[tracing::instrument(level = "trace", ret(skip), skip(segment))]
...
impl Connection {
    #[tracing::instrument(level = "trace", ret(skip), skip(segment,local_rwnd_size,rto_period,rto_count_max))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,flags))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,segment))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,s))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,now))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,window_size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,ack,window_size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,value))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,s,flags))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,s,buf,now))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,mss_reserved,seq,ack,flags_after_ns,payload))]
...
pub(crate) mod tests {
    ...
    impl ConnectionTester {
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,add_mss_option,payload))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,buf))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,data_buf))]
        pub fn write_data<'a>(
            &self,
            buf: &'a mut [u8],
            data_buf: &[u8],
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,c,s))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,c,payload_src))]
        ...
        // TcpFlags::RST.
        #[tracing::instrument(level = "trace", ret(skip), skip(self,c,s,recv_flags,additional_segment_flags))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,c))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(s,options_len,flags_after_ns))]
    ...
    // are set (besides ACK).
    #[tracing::instrument(level = "trace", ret(skip), skip(s,ack_number,additional_flags))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(c))]
