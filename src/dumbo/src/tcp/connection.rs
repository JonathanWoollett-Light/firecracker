...
#[tracing::instrument(level = "info", skip(segment))]
...
impl Connection {
    ...
    #[tracing::instrument(level = "info", skip(self, flags))]
    ...
    #[tracing::instrument(level = "info", skip(self, segment))]
    ...
    #[tracing::instrument(level = "info", skip(self, s))]
    ...
    #[tracing::instrument(level = "info", skip(self, now))]
    ...
    #[tracing::instrument(level = "info", skip(self, window_size))]
    ...
    #[tracing::instrument(level = "info", skip(self, ack, window_size))]
    ...
    #[tracing::instrument(level = "info", skip(self, s, flags))]
    ...
    #[tracing::instrument(level = "info", skip(self, s, buf, now))]
    ...
    #[tracing::instrument(level = "info", skip(self, buf, mss_reserved))]
    ...
    #[tracing::instrument(level = "info", skip(self, buf, mss_reserved, payload_src, now))]
...
pub(crate) mod tests {
    ...
    impl ConnectionTester {
        ...
        #[tracing::instrument(level = "info", skip(self, buf, add_mss_option, payload))]
        ...
        #[tracing::instrument(level = "info", skip(self, buf, data_buf))]
        pub fn write_data<'a>(
            &self,
            buf: &'a mut [u8],
            data_buf: &[u8],
        ...
        #[tracing::instrument(level = "info", skip(self, c, s))]
        ...
        #[tracing::instrument(level = "info", skip(self, c, payload_src))]
        ...
        #[tracing::instrument(level = "info", skip(self, c))]
    ...
    #[tracing::instrument(level = "info", skip(s, options_len, flags_after_ns))]
    ...
    // are set (besides ACK).
    #[tracing::instrument(level = "info", skip(s, ack_number, additional_flags))]
    ...
    #[tracing::instrument(level = "info", skip(c))]
