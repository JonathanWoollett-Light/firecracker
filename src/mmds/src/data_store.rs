...
impl Mmds {
    #[tracing::instrument(level = "info", skip(data_store_limit))]
    ...
    #[tracing::instrument(level = "info", skip(self, version))]
    ...
    #[tracing::instrument(level = "info", skip(self, data_store_limit))]
    ...
    #[tracing::instrument(level = "info", skip(self, patch_data))]
    ...
    #[tracing::instrument(level = "info", skip(json))]
    ...
    #[tracing::instrument(level = "info", skip(self, path, format))]
