...
impl From<MediaType> for OutputFormat {
    #[tracing::instrument(level = "trace", ret(skip), skip(media_type))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(http_version,status_code,body))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(target,patch))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(uri))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mmds,request))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mmds,request,token_headers))]
