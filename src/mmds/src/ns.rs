...
impl MmdsNetworkStack {
    ...
    #[tracing::instrument(level = "info", skip(mmds_ipv4_addr, mmds))]
    ...
    #[tracing::instrument(level = "info", skip(self, src))]
    ...
    #[tracing::instrument(level = "info", skip(self, eth))]
    ...
    #[tracing::instrument(level = "info", skip(self, buf, ethertype))]
...
mod tests {
    ...
    impl MmdsNetworkStack {
        #[tracing::instrument(level = "info", skip(self, buf, for_mmds))]
        ...
        #[tracing::instrument(level = "info", skip(self, buf, addr, flags))]
