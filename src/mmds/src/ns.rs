...
impl MmdsNetworkStack {
    #[tracing::instrument(level = "trace", ret(skip), skip(mac_addr,ipv4_addr,tcp_port,max_connections,max_pending_resets,mmds))]
    pub fn new(
        mac_addr: MacAddr,
        ipv4_addr: Ipv4Addr,
        tcp_port: u16,
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(mmds_ipv4_addr,mmds))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,src))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,eth))]
...
mod tests {
    ...
    impl MmdsNetworkStack {
        #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,for_mmds))]
        ...
        #[tracing::instrument(level = "trace", ret(skip), skip(self,buf,addr,flags))]
