...
impl MmdsNetworkStack {
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(mmds_ipv4_addr, mmds))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, src))]
    ...
    #[tracing::instrument(level = "debug", ret(skip), skip(self, eth))]
    ...
    #[tracing::instrument(level = "debug", skip(self, buf, ethertype))]
...
mod tests {
    ...
    impl MmdsNetworkStack {
        #[tracing::instrument(level = "debug", ret(skip), skip(self, buf, for_mmds))]
        ...
        #[tracing::instrument(level = "debug", ret(skip), skip(self, buf, addr, flags))]
