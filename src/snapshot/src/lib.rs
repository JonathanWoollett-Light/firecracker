...
#[tracing::instrument(level = "trace", ret(skip), skip(magic_id))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(format_version))]
fn build_magic_id(format_version: u16) -> u64 {
    BASE_MAGIC_ID | u64::from(format_version)
}

impl Snapshot {
    #[tracing::instrument(level = "trace", ret(skip), skip(version_map,target_version))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(reader,version_map))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(reader,snapshot_len,version_map))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,writer,object))]
