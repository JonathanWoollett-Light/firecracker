...
#[tracing::instrument(level = "info", skip(magic_id))]
...
#[tracing::instrument(level = "info", skip(format_version))]
fn build_magic_id(format_version: u16) -> u64 {
    BASE_MAGIC_ID | u64::from(format_version)
}

impl Snapshot {
    #[tracing::instrument(level = "info", skip(version_map, target_version))]
    ...
    #[tracing::instrument(level = "info", skip(reader, version_map))]
    ...
    #[tracing::instrument(level = "info", skip(reader, snapshot_len, version_map))]
    ...
    #[tracing::instrument(level = "info", skip(self, writer, object))]
