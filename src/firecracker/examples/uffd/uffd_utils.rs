...
impl UffdPfHandler {
    #[tracing::instrument(level = "trace", ret(skip), skip(stream,data,size))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,start,end,state))]
    ...
    #[tracing::instrument(level = "trace", ret(skip), skip(self,region))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(mappings))]
