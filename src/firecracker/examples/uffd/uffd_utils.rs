...
impl UffdPfHandler {
    #[tracing::instrument(level = "info", skip(stream, data, size))]
    ...
    #[tracing::instrument(level = "info", skip(self, start, end, state))]
    ...
    #[tracing::instrument(level = "info", skip(self, region))]
...
#[tracing::instrument(level = "info", skip(mappings))]
