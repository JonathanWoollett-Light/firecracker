...
impl SeccompConfig {
    #[tracing::instrument(level = "trace", ret(skip), skip(no_seccomp,seccomp_filter))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(config))]
...
#[tracing::instrument(level = "trace", ret(skip), skip(reader))]
