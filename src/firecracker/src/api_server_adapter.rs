...
impl ApiServerAdapter {
    #[tracing::instrument(level = "trace", skip(api_event_fd,from_api,to_api,vm_resources,vmm,event_manager))]
...
#[tracing::instrument(level = "trace", skip(seccomp_filters,config_json,bind_path,instance_info,process_time_reporter,boot_timer_enabled,api_payload_limit,mmds_size_limit,metadata_json))]
