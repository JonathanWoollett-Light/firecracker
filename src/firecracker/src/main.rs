...
#[tracing::instrument(level = "trace", skip(seccomp_filters,event_manager,config_json,instance_info,boot_timer_enabled,mmds_size_limit,metadata_json))]
...
#[tracing::instrument(level = "trace", skip(seccomp_filters,config_json,instance_info,bool_timer_enabled,mmds_size_limit,metadata_json))]
fn run_without_api(
    seccomp_filters: &BpfThreadMap,
